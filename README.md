...
[![Container Repository on Quay](https://quay.io/repository/samdoran/ubuntu18-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/ubuntu18-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t ubuntu18-ansible -f Containerfile .
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-ubuntu18}-ansible:latest"
